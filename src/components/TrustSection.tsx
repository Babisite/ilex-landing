  ...
  return (
    <section className="relative min-h-[60vh] sm:min-h-[80vh] lg:min-h-screen bg-gray-900 text-white overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Blob principal doré - caché sur mobile */}
        <div
          className="hidden sm:block absolute top-10 sm:top-20 left-10 sm:left-20 w-32 sm:w-64 lg:w-96 h-32 sm:h-64 lg:h-96 bg-gradient-to-br from-yellow-400 to-orange-400 opacity-3 sm:opacity-6 lg:opacity-8"
          style={{
        ...
        <div
          className="absolute bottom-16 sm:bottom-32 right-5 sm:right-10 w-24 sm:w-48 lg:w-80 h-24 sm:h-48 lg:h-80 bg-gradient-to-br from-green-400 to-lime-400 opacity-2 sm:opacity-4 lg:opacity-6"
          style={{
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-8 sm:py-12 lg:py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center mb-8 sm:mb-12 lg:mb-20">
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:gap-6 order-1 lg:order-2">
            ...
            <div className="group relative">
              <div className="absolute inset-0 bg-gradient-to-br from-green-400 to-lime-400 opacity-5 sm:opacity-10 blur-lg sm:blur-xl group-hover:opacity-15 sm:group-hover:opacity-20 transition-opacity duration-500"></div>
              <div className="relative bg-gray-800/80 backdrop-blur-sm border border-gray-700 p-3 sm:p-6 lg:p-8 text-center hover:border-amber-400/50 transition-all duration-500 group-hover:transform group-hover:scale-105 rounded-2xl sm:rounded-3xl">
                <div className="text-2xl sm:text-3xl lg:text-4xl mb-2 sm:mb-3 lg:mb-4">🛡️</div>
                <div className="text-sm sm:text-lg lg:text-xl font-black text-amber-400 mb-1 sm:mb-2 lg:mb-3">
                ...
                <div className="text-amber-400 text-xs sm:text-sm mt-1 sm:mt-2">Protection complète</div>
              </div>
            </div>
            ...
            <div className="group relative">
              <div className="absolute inset-0 bg-gradient-to-br from-orange-400 to-yellow-400 opacity-5 sm:opacity-10 blur-lg sm:blur-xl group-hover:opacity-15 sm:group-hover:opacity-20 transition-opacity duration-500"></div>
              <div className="relative bg-gray-800/80 backdrop-blur-sm border border-gray-700 p-3 sm:p-6 lg:p-8 text-center hover:border-orange-400/50 transition-all duration-500 group-hover:transform group-hover:scale-105 rounded-2xl sm:rounded-3xl">
                <div className="text-2xl sm:text-3xl lg:text-4xl mb-2 sm:mb-3 lg:mb-4">💬</div>
                <div className="text-sm sm:text-lg lg:text-xl font-black text-orange-400 mb-1 sm:mb-2 lg:mb-3">
                ...
                <div className="text-orange-400 text-xs sm:text-sm mt-1 sm:mt-2">
